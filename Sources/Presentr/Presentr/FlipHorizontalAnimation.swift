...
public class FlipHorizontalAnimation: PresentrAnimation {
    ...
    // This is the overriding method, which is not guaranteed to be on the MainActor
    override public func performAnimation(using transitionContext: PresentrTransitionContext) {
        self.animateFlip(transitionContext: transitionContext)
    }
    
    // This function is isolated to the MainActor
    @MainActor
    func animateFlip(transitionContext: PresentrTransitionContext) {
